...
class Book
{
    ...
    async indexBookView(indexYml)
    {
        ...
        {
            let chView = await this._indexChapterView(chapter);
    ...
    async _indexChapterView(chapter)
    {
        ...
        for( var content of chapter.content )
        {
            ...
            if( typeof(content) == "string" )
            {
                ...
                view.content.push( {title: title, source: source, chapterLink: chapterLink, link: link} );
            }
